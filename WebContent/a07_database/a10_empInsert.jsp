...
<%
	...
	//ex) a04_searchDeptList.jsp 화면에서 등록처리하는 화면 구현과 dao처리하세요.
%>
	<script>
		var ename = "<%=ename%>";
		if(ename!=""){
	...
	<table>
		...
		<tr><th>관리자번호</th><td><input type="text" name="mgr"/></td></tr>
		...
		<tr><td colspan="2"><input type="button" value="등록" onclick="validCk()"/></td></tr>
	</table>
	</form>
	<script>
		function validCk(){
